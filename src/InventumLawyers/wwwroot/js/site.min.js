...
*/
(function(n,t,i){"use strict";function f(t){typeof module=="object"&&typeof module.exports=="object"?module.exports=t:typeof define=="function"&&define.amd&&define("picturefill",function(){return t});typeof n=="object"&&(n.picturefill=t)}function u(n){var s,t,i,u,f,h=n||{},o,c;for(s=h.elements||r.getAllElements(),o=0,c=s.length;o<c;o++)if((t=s[o],i=t.parentNode,u=undefined,f=undefined,t.nodeName.toUpperCase()==="IMG")&&(t[r.ns]||(t[r.ns]={}),h.reevaluate||!t[r.ns].evaluated)){if(i&&i.nodeName.toUpperCase()==="PICTURE"){if(r.removeVideoShim(i),u=r.getMatch(t,i),u===!1)continue}else u=undefined;(i&&i.nodeName.toUpperCase()==="PICTURE"||!r.sizesSupported&&t.srcset&&e.test(t.srcset))&&r.dodgeSrcset(t);u?(f=r.processSourceSet(u),r.applyBestCandidate(f,t)):(f=r.processSourceSet(t),(t.srcset===undefined||t[r.ns].srcset)&&r.applyBestCandidate(f,t));t[r.ns].evaluated=!0}}function o(){function f(){clearTimeout(i);i=setTimeout(o,60)}r.initTypeDetects();u();var e=setInterval(function(){if(u(),/^loaded|^i|^c/.test(t.readyState)){clearInterval(e);return}},250),i,o=function(){u({reevaluate:!0})};n.addEventListener?n.addEventListener("resize",f,!1):n.attachEvent&&n.attachEvent("onresize",f)}if(n.HTMLPictureElement){f(function(){});return}t.createElement("picture");var r=n.picturefill||{},e=/\s+\+?\d+(e\d+)?w/;r.ns="picturefill",function(){r.srcsetSupported="srcset"in i;r.sizesSupported="sizes"in i;r.curSrcSupported="currentSrc"in i}();r.trim=function(n){return n.trim?n.trim():n.replace(/^\s+|\s+$/g,"")};r.makeUrl=function(){var n=t.createElement("a");return function(t){return n.href=t,n.href}}();r.restrictsMixedContent=function(){return n.location.protocol==="https:"};r.matchesMedia=function(t){return n.matchMedia&&n.matchMedia(t).matches};r.getDpr=function(){return n.devicePixelRatio||1};r.getWidthFromLength=function(n){var i;if(!(n&&n.indexOf("%")>-1==!1&&(parseFloat(n)>0||n.indexOf("calc(")>-1)))return!1;n=n.replace("vw","%");r.lengthEl||(r.lengthEl=t.createElement("div"),r.lengthEl.style.cssText="border:0;display:block;font-size:1em;left:0;margin:0;padding:0;position:absolute;visibility:hidden",r.lengthEl.className="helper-from-picturefill-js");r.lengthEl.style.width="0px";try{r.lengthEl.style.width=n}catch(u){}return t.body.appendChild(r.lengthEl),i=r.lengthEl.offsetWidth,i<=0&&(i=!1),t.body.removeChild(r.lengthEl),i};r.detectTypeSupport=function(t,i){var f=new n.Image;return f.onerror=function(){r.types[t]=!1;u()},f.onload=function(){r.types[t]=f.width===1;u()},f.src=i,"pending"};r.types=r.types||{};r.initTypeDetects=function(){r.types["image/jpeg"]=!0;r.types["image/gif"]=!0;r.types["image/png"]=!0;r.types["image/svg+xml"]=t.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image","1.1");r.types["image/webp"]=r.detectTypeSupport("image/webp","data:image/webp;base64,UklGRh4AAABXRUJQVlA4TBEAAAAvAAAAAAfQ//73v/+BiOh/AAA=")};r.verifyTypeSupport=function(n){var i=n.getAttribute("type"),t;return i===null||i===""?!0:(t=r.types[i],typeof t=="string"&&t!=="pending"?(r.types[i]=r.detectTypeSupport(i,t),"pending"):typeof t=="function"?(t(),"pending"):t)};r.parseSize=function(n){var t=/(\([^)]+\))?\s*(.+)/g.exec(n);return{media:t&&t[1],length:t&&t[2]}};r.findWidthFromSourceSize=function(i){for(var f=r.trim(i).split(/\s*,\s*/),e,u=0,c=f.length;u<c;u++){var l=f[u],o=r.parseSize(l),s=o.length,h=o.media;if(s&&(!h||r.matchesMedia(h))&&(e=r.getWidthFromLength(s)))break}return e||Math.max(n.innerWidth||0,t.documentElement.clientWidth)};r.parseSrcset=function(n){for(var f=[],r,t,i,e,u;n!=="";)n=n.replace(/^\s+/g,""),r=n.search(/\s/g),i=null,r!==-1?(t=n.slice(0,r),e=t.slice(-1),(e===","||t==="")&&(t=t.replace(/,+$/,""),i=""),n=n.slice(r+1),i===null&&(u=n.indexOf(","),u!==-1?(i=n.slice(0,u),n=n.slice(u+1)):(i=n,n=""))):(t=n,n=""),(t||i)&&f.push({url:t,descriptor:i});return f};r.parseDescriptor=function(n,t){var c=t||"100vw",h=n&&n.replace(/(^\s+|\s+$)/g,""),l=r.findWidthFromSourceSize(c),o,s,u,i,f,e;if(h)for(s=h.split(" "),u=s.length-1;u>=0;u--)i=s[u],f=i&&i.slice(i.length-1),f!=="h"&&f!=="w"||r.sizesSupported?f==="x"&&(e=i&&parseFloat(i,10),o=e&&!isNaN(e)?e:1):o=parseFloat(parseInt(i,10)/l);return o||1};r.getCandidatesFromSourceSet=function(n,t){for(var u,f=r.parseSrcset(n),e=[],i=0,o=f.length;i<o;i++)u=f[i],e.push({url:u.url,resolution:r.parseDescriptor(u.descriptor,t)});return e};r.dodgeSrcset=function(n){n.srcset&&(n[r.ns].srcset=n.srcset,n.srcset="",n.setAttribute("data-pfsrcset",n[r.ns].srcset))};r.processSourceSet=function(n){var t=n.getAttribute("srcset"),u=n.getAttribute("sizes"),i=[];return n.nodeName.toUpperCase()==="IMG"&&n[r.ns]&&n[r.ns].srcset&&(t=n[r.ns].srcset),t&&(i=r.getCandidatesFromSourceSet(t,u)),i};r.backfaceVisibilityFix=function(n){var t=n.style||{},i="webkitBackfaceVisibility"in t,r=t.zoom;i&&(t.zoom=".999",i=n.offsetWidth,t.zoom=r)};r.setIntrinsicSize=function(){var i={},u=function(n,t,i){t&&n.setAttribute("width",parseInt(t/i,10))};return function(f,e){var o;f[r.ns]&&!n.pfStopIntrinsicSize&&((f[r.ns].dims===undefined&&(f[r.ns].dims=f.getAttribute("width")||f.getAttribute("height")),f[r.ns].dims)||(e.url in i?u(f,i[e.url],e.resolution):(o=t.createElement("img"),o.onload=function(){if(i[e.url]=o.width,!i[e.url])try{t.body.appendChild(o);i[e.url]=o.width||o.offsetWidth;t.body.removeChild(o)}catch(n){}f.src===e.url&&u(f,i[e.url],e.resolution);f=null;o.onload=null;o=null},o.src=e.url)))}}();r.applyBestCandidate=function(n,t){var f,e,i,u;for(n.sort(r.ascendingSort),e=n.length,i=n[e-1],u=0;u<e;u++)if(f=n[u],f.resolution>=r.getDpr()){i=f;break}i&&(i.url=r.makeUrl(i.url),t.src!==i.url&&(r.restrictsMixedContent()&&i.url.substr(0,5).toLowerCase()==="http:"?window.console!==undefined&&console.warn("Blocked mixed content image "+i.url):(t.src=i.url,r.curSrcSupported||(t.currentSrc=t.src),r.backfaceVisibilityFix(t))),r.setIntrinsicSize(t,i))};r.ascendingSort=function(n,t){return n.resolution-t.resolution};r.removeVideoShim=function(n){var r=n.getElementsByTagName("video"),t,i;if(r.length){for(t=r[0],i=t.getElementsByTagName("source");i.length;)n.insertBefore(i[0],t);t.parentNode.removeChild(t)}};r.getAllElements=function(){for(var n,u=[],f=t.getElementsByTagName("img"),i=0,e=f.length;i<e;i++)n=f[i],(n.parentNode.nodeName.toUpperCase()==="PICTURE"||n.getAttribute("srcset")!==null||n[r.ns]&&n[r.ns].srcset!==null)&&u.push(n);return u};r.getMatch=function(n,t){for(var i,e,o,s=t.childNodes,u,f=0,h=s.length;f<h;f++)if(i=s[f],i.nodeType===1){if(i===n)return u;if(i.nodeName.toUpperCase()==="SOURCE"&&(i.getAttribute("src")!==null&&typeof console!==undefined&&console.warn("The `src` attribute is invalid on `picture` `source` element; instead, use `srcset`."),e=i.getAttribute("media"),i.getAttribute("srcset"))&&(!e||r.matchesMedia(e)))if(o=r.verifyTypeSupport(i),o===!0){u=i;break}else if(o==="pending")return!1}return u};o();u._=r;f(u)})(window,window.document,new window.Image);Carousel={directionNav:"[data-carousel-direction]",directionNext:'[data-carousel-direction="next"]',directionPrev:'[data-carousel-direction="prev"]',pagination:"[data-carousel-pagination]",selector:"[data-carousel]",togglePagination:"data-carousel-has-pagination",options:{},init:function(){window.matchMedia("only screen and (min-width: "+ClientSettings.bpDesk+"em)").matches&&$(this.selector).length&&$(this.selector).each(function(){var n=$(this);Carousel.setOptions(n)})},setOptions:function(n){this.options={calculateHeight:!0,grabCursor:!1,mode:"horizontal",resistance:"100%",roundLengths:!0,simulateTouch:!0,speed:500,updateOnImagesReady:!0,visibilityFullFit:!0,onSwiperCreated:function(t){Carousel.setDirectionState(n,t);t.resizeFix()},onSlideChangeEnd:function(t){Carousel.setDirectionState(n,t)},onTouchEnd:function(t){Carousel.setDirectionState(n,t)}};this.customOptions(n);this.build(n)},customOptions:function(n){var t=n[0].hasAttribute(this.togglePagination),i=n.siblings(this.pagination)[0];t&&(this.options.createPagination=!0,this.options.pagination=i,this.options.paginationClickable=!0,this.options.paginationElement="li")},build:function(n){n.swiper(this.options);this.bindDirectionNav()},bindDirectionNav:function(){$(this.directionNav).on("click",function(){var t=$(this),r=t.siblings("[data-carousel]"),n=r.data("swiper"),i=t.data("carousel-direction");i=="next"?n.swipeNext():i=="prev"?n.swipePrev():(n=$(this).parents("[data-carousel]").data("swiper"),n.swipeNext(),e.preventDefault())})},setDirectionState:function(n,t){var i=n.siblings(this.directionPrev),r=n.siblings(this.directionNext);t.activeIndex===0?(i[0].disabled=!0,r[0].disabled=!1):t.activeIndex+t.visibleSlides.length===t.slides.length?(i[0].disabled=!1,r[0].disabled=!0):(i[0].disabled=!1,r[0].disabled=!1)}};Collapsible={toggleSelector:document.querySelectorAll("[data-collapsible-toggle]"),toggleTextAttr:"data-collapsible-text",accordionAttr:"data-collapsible-accordion",accordionParentAttr:"data-accordion",expanderAttr:"data-collapsible-expander",initialHeightAttr:"data-initial-height",prefix:"collapsible-",animationClass:"no-animate",animationDuration:250,init:function(){"querySelector"in document&&"addEventListener"in window&&Collapsible.toggleSelector.length?(Collapsible.addDocumentClass(Collapsible.prefix+"active"),Collapsible.buildAll()):Collapsible.addDocumentClass(Collapsible.prefix+"inactive")},addDocumentClass:function(n){Utilities.addClass(Constants.root,n)},buildAll:function(){for(var n,i=0,t=0;t<Collapsible.toggleSelector.length;t++){var n=Collapsible.toggleSelector[t],r=n.offsetHeight,u=Utilities.getNextSibling(n);Collapsible.addAria(n,u,t);Collapsible.isAccordion(n)&&(i=r>i?r:i);Collapsible.bindClickEvents(n)}for(t=0;t<Collapsible.toggleSelector.length;t++)n=Collapsible.toggleSelector[t],Collapsible.isAccordion(n)&&(Collapsible.setDefaultHeight(n,i),Collapsible.setDefaultHeight(n.parentNode,Utilities.getOuterHeight(n)))},addAria:function(n,t,i){n.setAttribute("aria-expanded",!1);n.setAttribute("aria-controls",Collapsible.prefix+i);t.id=Collapsible.prefix+i;t.setAttribute("aria-hidden",!0)},isAccordion:function(n){return Utilities.parentElementWithAttribute(n,Collapsible.accordionParentAttr)},isExpander:function(n){return Utilities.parentElementWithAttribute(n,Collapsible.expanderAttr)},setDefaultHeight:function(n,t){n.style.height=t+"px"},bindClickEvents:function(n){Utilities.addEventListener(n,"click",function(t){Collapsible.toggleEvent(n);t.preventDefault()})},toggleEvent:function(n){var i=n.getAttribute("aria-expanded")==="false"?!0:!1,t=Collapsible.isAccordion(n);if(t){var f=document.body.getBoundingClientRect(),e=n.getBoundingClientRect(),r=parseInt(e.top,10)-parseInt(f.top,10),u=t.querySelector('[aria-expanded="true"]'),o=parseInt(t.getAttribute(Collapsible.accordionParentAttr),10);i&&r===o?Utilities.addClass(t,Collapsible.animationClass):Utilities.removeClass(t,Collapsible.animationClass);i?(t.setAttribute(Collapsible.accordionParentAttr,r),!u||Collapsible.toggleState(u,!i)):t.setAttribute(Collapsible.accordionParentAttr,"")}Collapsible.toggleState(n,i)},toggleText:function(n,t){var r=n.innerHTML,i=n.getAttribute(Collapsible.toggleTextAttr),u=t?Collapsible.animationDuration:0;i&&(n.innerHTML=i,n.setAttribute(Collapsible.toggleTextAttr,r))},toggleState:function(n,t){var i=Utilities.getNextSibling(n);n.setAttribute("aria-expanded",t);i.setAttribute("aria-hidden",!t);Collapsible.toggleText(n,t);Collapsible.animateHeight(n,i,t)},animateHeight:function(n,t,i){var u,r;Collapsible.isExpander(n)?(u=i?t.offsetHeight:t.getAttribute(Collapsible.initialHeightAttr),t.setAttribute(Collapsible.initialHeightAttr,u),r=i?Utilities.findChildHeight(t):u,t.style.paddingTop=r+"px"):(r=i?Utilities.findChildHeight(t):0,t.style.height=r+"px",Collapsible.isAccordion(n)&&(n.parentNode.style.height=r+Utilities.getOuterHeight(n)+"px"))}};var Links={selector:"[data-target]",viewport:"html, body",targetNewWindow:"new-window",targetPageTop:"page-top",targetOnPage:"on-page",targetSkip:"skip",event:"click",eventNamespace:"links",headerSelector:"[data-site-header]",offsetValue:0,scrollDuration:600,init:function(){$(this.selector).length&&(this.setHeaderHeight(),this.loopSelectors())},setHeaderHeight:function(){Links.offsetValue=$(this.headerSelector).height()},loopSelectors:function(){$(this.selector).each(function(){var n=$(this),t=Links.matchBoundEvent(n);t||Links.bindClick(n)})},bindClick:function(n){n.on(this.event+"."+this.eventNamespace,function(t){var i=n.attr("href"),r=n.data("target"),u=Links.getTargetEvent(r);u(i);t.preventDefault()})},newWindow:function(n){window.open(n,"popup","width=500, height=420, scrollbars=no, resizable=yes")},onPage:function(n){$(Links.viewport).stop().animate({scrollTop:Math.ceil($(n).offset().top)-Links.offsetValue},Links.scrollDuration);$(".nav-primary__list-item").width()>=300&&OffCanvas.closeOffCanvas()},pageTop:function(){$(window).scrollTop()>0&&$(Links.viewport).stop().animate({scrollTop:0},Links.scrollDuration)},skip:function(n){$(n).attr("tabindex","-1").focus()},matchBoundEvent:function(n){var r=!1,u=this.getBoundEvents(n),t,i;if(!!!u||(t=u[this.event],!!!t))return!1;for(i=0;i<t.length;i++)t[i].namespace===this.eventNamespace&&(r=!0);return r},getTargetEvent:function(n){switch(n){case this.targetNewWindow:return this.newWindow;case this.targetOnPage:return this.onPage;case this.targetSkip:return this.skip;case this.targetPageTop:return this.pageTop}},getBoundEvents:function(n){return $._data(n[0],"events")}},OffCanvas={header:document.getElementById("site-header"),container:document.getElementById("container-off-canvas"),btnOpen:document.getElementById("btn-off-canvas-open"),btnClose:document.getElementById("btn-off-canvas-close"),toggleClass:"off-canvas-is-visible",animateReadyClass:"container-off-canvas--is-animate-ready",openEventBound:!1,closeEventBound:!1,init:function(){OffCanvas.btnOpen&&OffCanvas.run()},run:function(){OffCanvas.bindOpenEvent();Utilities.addClass(OffCanvas.container,OffCanvas.animateReadyClass)},bindOpenEvent:function(){OffCanvas.btnOpen.addEventListener("click",OffCanvas.openOffCanvas,!1);OffCanvas.openEventBound=!0},unbindOpenEvent:function(){OffCanvas.btnOpen.removeEventListener("click",OffCanvas.openOffCanvas,!1);OffCanvas.openEventBound=!1},bindCloseEvent:function(){OffCanvas.btnClose.addEventListener("click",OffCanvas.closeOffCanvas,!1);OffCanvas.closeEventBound=!0},unbindCloseEvent:function(){OffCanvas.btnClose.removeEventListener("click",OffCanvas.closeOffCanvas,!1);OffCanvas.closeEventBound=!1},openOffCanvas:function(){Utilities.addClass(Constants.root,OffCanvas.toggleClass);OffCanvas.bindCloseEvent()},closeOffCanvas:function(){Utilities.removeClass(Constants.root,OffCanvas.toggleClass);OffCanvas.unbindCloseEvent()}},Tabs={selector:"[data-tab-container]",content:"[data-tab-content]",button:"[data-tab-button]",buttonListSelector:"[data-tab-list]",buttonListItem:"[data-tab-item]",currentClass:"current",init:function(){$(this.selector).length&&(this.setAriaAttrs(),this.bindClickEvents())},setAriaAttrs:function(){$(this.selector).each(function(n){var t=$(this);$(Tabs.button,t).each(function(i){var u=$(this),r="tab-"+n+i;u.attr("aria-controls",r);t.find(Tabs.content).eq(i).attr("id",r).attr("aria-hidden",!0)});t.find(Tabs.content).eq(0).attr("aria-hidden",!1)})},bindClickEvents:function(){$(this.button,this.selector).on("click",function(){var n=$(this),t=n.parents(Tabs.selector),r=n.attr("aria-controls"),i=$("#"+r),u=$(window).scrollTop();i.attr("aria-hidden",!0)&&(t.find(Tabs.content).attr("aria-hidden",!0).removeClass(Tabs.currentClass),i.attr("aria-hidden",!1).attr("tabindex",-1).focus().addClass(Tabs.currentClass),window.scrollTo(0,u),t.find(Tabs.button).removeClass(Tabs.currentClass),n.addClass(Tabs.currentClass))})}};Utilities={addEventListener:function(n,t,i){n.addEventListener?n.addEventListener(t,i,!0):n.attachEvent("on"+t,function(){i.call(n)})},removeEventListener:function(n,t,i){n.removeEventListener?n.removeEventListener(t,i):n.detachEvent("on"+t,i)},addClass:function(n,t){n.classList?n.classList.add(t):n.className+=" "+t},findChildHeight:function(n){for(var i=0,t=0;t<n.children.length;t++)i+=Utilities.getOuterHeight(n.children[t]);return i},getNextSibling:function(n){for(var t=n.nextSibling;t.nodeType!==1;)t=t.nextSibling;return t},getOuterHeight:function(n){var i=n.offsetHeight,t=n.currentStyle||getComputedStyle(n),r=t.marginTop.indexOf("em")!==-1?Math.ceil(parseFloat(t.marginTop,10)*16):parseInt(t.marginTop,10),u=t.marginBottom.indexOf("em")!==-1?Math.ceil(parseFloat(t.marginBottom,10)*16):parseInt(t.marginBottom,10);return i+(r+u)},hasClass:function(n,t){return n.classList?n.classList.contains(t):new RegExp("(^| )"+t+"( |$)","gi").test(n.className)},parentElementWithAttribute:function(n,t){for(var i=n.parentNode;i!==document.body;){if(i.hasAttribute(t))return i;i=i.parentNode}return null},removeClass:function(n,t){n.classList?n.classList.remove(t):n.className=n.className.replace(new RegExp("(^|\\b)"+t.split(" ").join("|")+"(\\b|$)","gi")," ")}};Constants={root:document.documentElement};Collapsible.init();ToggleBusinessValue={selector:"[data-value-button]",containerSelector:"[data-container-value]",toggleClassContainer:"model-drawer--is-opened",init:function(){ToggleBusinessValue.bindClickEvent()},bindClickEvent:function(){$(ToggleBusinessValue.selector).on("click",function(n){var t=$(ToggleBusinessValue.containerSelector).hasClass(ToggleBusinessValue.toggleClassContainer)?!0:!1;$(ToggleBusinessValue.containerSelector).toggleClass(ToggleBusinessValue.toggleClassContainer);Expander.animateOuter();t&&(Expander.toggleExpander($(Expander.button).not('[aria-expanded="false"]'),!1),Expander.setPaddingBottom($(".model__inner"),10));$(EqualHeight.selector).css("min-height",0);EqualHeight.init();n.preventDefault()})}};jQuery.extend(jQuery.easing,{easeOutQuart:function(n,t,i,r,u){return-r*((t=t/u-1)*t*t*t-1)+i},easeInOutQuad:function(n,t,i,r,u){if((t/=u/2)<1)return r/2*t*t+i},easeOutQuad:function(n,t,i,r,u){return-r*(t/=u)*(t-2)+i}});var EqualHeight={selector:"[data-equal-height-item]",selectorContainer:".model-drawer--is-opened .model__outer",init:function(){this.setHeight()},setHeight:function(){var n=0;$(EqualHeight.selector).each(function(){$(this).outerHeight()>n&&(n=$(this).outerHeight())});$(EqualHeight.selector).css("min-height",n);$(EqualHeight.selectorContainer).css("min-height",n)}},Expander={selector:"[data-expander]",button:"[data-expander-button]",content:"[data-expander-content]",container:"[data-expander-container]",isContent:"data-expander-content",isAccordion:"data-expander-is-accordion",isBusinessModel:"data-expander-is-business-model",bottomPadding:0,duration:0,init:function(){$(this.selector).length&&(this.setUp(),this.bindClickEvents())},setUp:function(){$(this.selector).each(function(n){var t=$(this),i="expander-"+n;$(Expander.button,t).attr({"aria-controls":i,"aria-expanded":!1});$(Expander.content,t).attr({id:i,"aria-hidden":!0})})},bindClickEvents:function(){$(this.button).on("click",function(){var n=$(this),i=n.attr("aria-expanded")==="false"?!0:!1,t=n.parents(Expander.container),r=t[0].hasAttribute(Expander.isAccordion),u=t[0].hasAttribute(Expander.isBusinessModel);r&&t.find(Expander.button).not(n).each(function(){var n=$(this);n.attr("aria-expanded")==="true"&&Expander.toggleExpander(n,!1)});Expander.toggleExpander(n,i);Expander.animateOuter()})},animateOuter:function(){$(EqualHeight.selector).css("min-height",0);var f=$(".model__outer"),r=$(".model__inner"),u=$(".model-drawer"),n=$(".drawer--left .model-drawer__inner").outerHeight(),t=$(".drawer--right .model-drawer__inner").outerHeight(),i=25;Expander.bottomPadding=t;n>t&&(Expander.bottomPadding=n);window.matchMedia("(max-width: "+(ClientSettings.bpLap*16-1)+"px)").matches?(Expander.setPaddingBottom(r,Expander.bottomPadding+i),u.css("bottom",Expander.bottomPadding+i+45)):$(".model__outer").css("min-height",Expander.bottomPadding);$(".model-drawer__inner").css("min-height",Expander.bottomPadding)},setPaddingBottom:function(n,t){window.matchMedia("(max-width: "+(ClientSettings.bpLap*16-1)+"px)").matches&&n.css("padding-bottom",t)},toggleExpander:function(n,t){var u=n.parents(this.selector),i=$(this.content,u),f=$(window).scrollTop();n.attr("aria-expanded",t);n.attr("disabled",!0);var r=n.attr("data-content-open"),e=n.attr("data-content-closed"),o=t?r:e;!r||n.html(o);i.slideToggle(this.duration,"easeInOutQuad",function(){i.attr("aria-hidden",!t);n.attr("disabled",!1);t?i.attr("tabindex","-1").focus():n.focus();window.scrollTo(0,f)})}},ToggleLeadership={selector:"[data-leadership]",isOpenedClass:"module-leadership__text--is-opened",init:function(){ToggleLeadership.bindClickEvent()},bindClickEvent:function(){$(this.selector).on("click",function(n){var t=$(this);t.toggleClass(ToggleLeadership.isOpenedClass);n.preventDefault()})}},Nav={selector:document.getElementById("site-header"),section:"[data-section]",navigation:"[data-nav-primary-link]",classCurrent:"nav-primary__link--is-current",containerHeader:".container-header",classActive:"container-header--active",init:function(){$(this.selector).length&&window.matchMedia("only screen and (min-width: 56.25em)").matches?(this.bindScroll(),this.scrollEvent(),this.addClassActive()):(this.unbindScroll(),this.removeScrollEvent())},bindScroll:function(){$(window).on("scroll.nav",function(){Nav.scrollEvent();Nav.addClassActive()})},unbindScroll:function(){$(window).off("scroll.nav")},scrollEvent:function(){var n=$(inView(Nav.section,"top",-80)),t,i;!n||(i=n.attr("id"),t=$(this.navigation+'[href="#'+i+'"]'),$(this.navigation).not(this.classCurrent).removeClass(this.classCurrent),t.addClass(this.classCurrent))},removeScrollEvent:function(){$(this.navigation).removeClass(this.classCurrent)},addClassActive:function(){var n=$(window).scrollTop();n>=60?$(Nav.containerHeader).addClass(Nav.classActive):$(Nav.containerHeader).removeClass(Nav.classActive)}},Video={selector:"[data-video-src]",trigger:"[data-video-play]",currVideo:"",init:function(){$(this.selector).length&&(this.assignID(),this.bindClickEvent())},assignID:function(){$(this.selector).each(function(n){$(this).attr("id","video_"+n)})},bindClickEvent:function(){$(this.trigger).on("click",function(){var n=$(this),i=n.attr("id"),t=n.parent(),r=t.data("video-src"),u=$(n).height(),f=$(n).width();Video.build(t,r,u,f);Video.pauseVideo(i)})},build:function(n,t,i,r){jwplayer.key="PYLpKA9orwVIg7kW8GavqUb4rRN+p3Iu6WG1Diw9o2o=";var u=navigator.userAgent.match(/(iPad|iPhone|iPod)/g)?!1:!0;jwplayer(n[0]).setup({sources:[{file:t+".mp4",type:"mp4"},{file:t+".webm",type:"webm"}],skin:"/Sharesandperformance/Annualreportandreview/2015summary/js/dist/BT-skin/btSkin.xml",height:i,width:r,autostart:u,logo:{hide:!0},events:{onPlay:function(){var t=n.attr("id");Video.pauseVideo(t)}}})},pauseVideo:function(n){$(".jwplayer, object").each(function(){currentMediaId=$(this).attr("id");(jwplayer(this).getState()==="PLAYING"||jwplayer(this).getState()==="BUFFERING")&&currentMediaId!==n&&jwplayer(this).pause(!0)})}},ClientSettings={bpLap:37.6875,bpDesk:64.063},Constants={root:document.documentElement},Master={load:function(){loadJS("//cdn.jsdelivr.net/jwplayer/6.7/jwplayer.js",Video.init());Carousel.init();Expander.init();Nav.init();OffCanvas.init();Links.init();Tabs.init();ToggleBusinessValue.init();ToggleLeadership.init()}};Master.load();$(window).on("resize",function(){Nav.addClassActive();Carousel.init();var n=setTimeout(function(){Expander.animateOuter();clearTimeout(n)},100)});